...
class Thursday : Fragment() {
    val WEEKDAY : String = "목"

    private lateinit var rv_thursday : RecyclerView
    private lateinit var rvManager: RecyclerView.LayoutManager
    var webtoonList : ArrayList<ListItem> = arrayListOf()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        var rootView = inflater.inflate(R.layout.fragment_thursday, container, false)

        //초기화
        rv_thursday = rootView.findViewById(R.id.rv_thursday)
    ...
    private fun getListOfWebtoonsByDay() {
        doAsync {
            val document = Jsoup.connect("https://comic.naver.com/webtoon/weekdayList.nhn?week=thu").get()
